...
require_relative "lib/shiplane/deployers/capistrano_docker/version"

Gem::Specification.new do |spec|
  spec.platform      = Gem::Platform::RUBY
  spec.name          = "shiplane_deployers_capistrano_docker"
  spec.version       = Shiplane::Deployers::CapistranoDocker::VERSION
